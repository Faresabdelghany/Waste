...
export const publicModuleDomains: readonly PublicModuleDomain[] = [
  ...
  },
  {
    ...
    boundaryNote:
      "A Product is the sellable definition; Agreement, Subscription, customer Price, and contractor compensation remain separate records.",
  },
  {
    ...
    canonicalOwner: "Commercial · Price Lists & Price Check",
    personas: ["Pricing manager", "Finance specialist", "Contract manager"],
    upstream: ["M01", "M02", "M03", "M05"],
    downstream: ["M03", "M05", "M15", "M16", "M18", "M23"],
    boundaryNote:
      "Customer Price Lists and contractor compensation are confidential, separately effective-dated models.",
  },
  {
