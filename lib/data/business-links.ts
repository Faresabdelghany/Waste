...
const fallbackModules: Array<ModuleLocation & { terms: string[] }> = [
  ...
  { workspaceId: "plan", moduleId: "pickup-settings", terms: ["pickup setting", "pickup settings"] },
  { workspaceId: "plan", moduleId: "calendar-days", terms: ["calendar day", "calendar days", "collection calendar day", "collection calendar days"] },
  { workspaceId: "plan", moduleId: "collection-weeks", terms: ["collection week", "collection weeks", "week rotation", "week rotations"] },
